...
namespace EventCheckin.Api.Utility.Extensions
{
    ...
    public static class RegisterServicesExtention
    {
        ...
        public static void RegisterUtilityServices_depricated(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            // Unit of work
            var eventEntitygingContext = Net7BoilerplateContext.Create(configuration.GetConnectionString("EventEntitygingDb"));
            ...
            services.AddSingleton<IUnitOfWork>(x => new UnitOfWork(eventEntitygingContext));
        }
        ...
        public static void AutoRegisterServices(this IServiceCollection services)
        {
            ...
            {
                RegisterEventEntitygingServicesFromAssembly(services, assembly);
            }
        }
        ...
        private static void RegisterEventEntitygingServicesFromAssembly(IServiceCollection services, Assembly assembly)
        {
            foreach (var type in assembly.GetTypes())
            {
