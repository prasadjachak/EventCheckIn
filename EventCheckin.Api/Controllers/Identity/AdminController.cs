...
namespace EventCheckin.Api.Controllers.Identity
{
    ...
    public class AdminController : BaseController
    {
        ...
        {
            var users = await _userService.GetUsers("SUPERADMIN");
        ...
        public async Task<ActionResult<CustomApiResponse>> AddUser(UserModel model)
        {
            ...
            try
            {
                if (user == null)
                {
                    ...
                    IdentityResult result2 = await _userManager.AddToRolesAsync(user, new List<string>() { "SUPERADMIN" });
                    user.LockoutEnabled = false;
        ...
        public async Task<ActionResult<CustomApiResponse>> UpdateUser(UserModel model)
        {
            ...
            await _userManager.AddToRolesAsync(user, new List<string>() { "SUPERADMIN" });
