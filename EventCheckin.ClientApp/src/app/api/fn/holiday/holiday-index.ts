...
export interface HolidayIndex$Params {
...
export function holidayIndex(http: HttpClient, rootUrl: string, params?: HolidayIndex$Params, context?: HttpContext): Observable<StrictHttpResponse<void>> {
  const rb = new RequestBuilder(rootUrl, holidayIndex.PATH, 'get');
  if (params) {
