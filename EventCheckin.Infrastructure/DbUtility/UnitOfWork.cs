...
using EventCheckin.Infrastructure.Events;
using EventCheckin.Utility.Exceptions;
using EventCheckin.Utility.Extensions;

namespace EventCheckin.Infrastructure.DbUtility
{
